...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (role == 0) {
            ...
            menu.findItem(R.id.menu_replenish).isVisible = true
            ...
            menu.findItem(R.id.menu_replenish).isVisible = false
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.menu_replenish -> {
                startActivity(Intent(this, ReplenishActivity::class.java))
            }
