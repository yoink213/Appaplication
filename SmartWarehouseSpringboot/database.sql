...
CREATE TABLE `big_warehouse`  (
  ...
  `code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '货物编号，格式 A-001',
  ...
  `location` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '存放货架位置',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '规格/描述',
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_code`(`code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '大仓库总库存表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `orders`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '订单编号，格式 ORD-000',
  `small_item_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '小仓库编号，格式 001',
...
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单/小仓任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_sequence`  (
  `seq_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '序列名称',
  `current_val` int NOT NULL DEFAULT 0 COMMENT '当前最新值',
  PRIMARY KEY (`seq_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统编号种子表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_sequence (已修正为与现有订单匹配的下一个编号)
-- ----------------------------
INSERT INTO `sys_sequence` VALUES ('ORDER_NO', 10);   -- 当前最大 ORD-009，下一个为 10，生成 ORD-010
INSERT INTO `sys_sequence` VALUES ('SMALL_ITEM', 11); -- 当前最大 010，下一个为 11，生成 011

-- ----------------------------
-- 存储过程：原子获取下一个序列号（行锁保证并发安全）
-- ----------------------------
DROP PROCEDURE IF EXISTS `next_seq_val`;
DELIMITER //
...
BEGIN
    ...
    -- 开启事务，对序列行加排他锁
    START TRANSACTION;
    SELECT current_val INTO cur FROM sys_sequence WHERE seq_name = seq_name FOR UPDATE;
    -- 递增
    UPDATE sys_sequence SET current_val = cur + 1 WHERE seq_name = seq_name;
    COMMIT;
    -- 返回递增前的值（即本次使用的编号基准）
    SET next_val = cur;
END //
...
-- 使用示例（Java 中通过 CallableStatement 调用）：
-- {call next_seq_val('ORDER_NO', ?)}
...
CREATE TABLE `users`  (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '登录密码（明文仅演示）',
